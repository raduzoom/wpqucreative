...
//                cthis.addClass('toggle_type-'+ o.toggle_type);
            ...
            function reinit(){
                ...
                cthis.children(selector).each(function(){
                    ...
                    if(!o.outer_menu){
                        ...
                        var font_group = 'font-group-2';

                        if(cthis.hasClass('skin-menu')){
                            font_group = 'h6';
                        }
                        _tabsMenu.children().last().find('a[data-vc-container]').removeAttr('href','').addClass('custom-a '+font_group);

                        //.children('.vc_tta-title-text').addClass('h6')
                    }
            ...
            function handleLoaded(){
                ...
                if(cthis.get(0)){
                    ...
                    cthis.get(0).api_close_all_tabs = function(){



                        _tabsMenu.find('.tab-menu-content-con').eq(0).css({
                            'height' : 0
                        })
                        _tabsMenu.children('.active').find('.tab-menu-content-con').eq(0).css({
                            'height' : 0
                        })

                        console.warn("_tabsMenu.children('.active') -3 ",_tabsMenu.children('.active'));
                ...
                if(cthis.hasClass('skin-chef')||cthis.hasClass('skin-qucreative')){
