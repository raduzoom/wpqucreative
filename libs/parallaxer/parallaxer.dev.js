...
(function($) {
    ...
    $.fn.dzsparallaxer = function(o) {
        ...
        var defaults = {
            ...
            , cthis_height_is_window_height: 'off' // -- if this is fullscreen parallaxer, then we can just follow
        ...
        this.each( function(){
            ...
            function init(){
                ...
                if(o.cthis_height_is_window_height=='on'){
            ...
            function calculate_dims(){
                ...
                if(o.settings_clip_height_is_window_height || o.cthis_height_is_window_height=='on'){
                    ch = window.innerHeight;
                }



                //console.info(ch, window.innerHeight);
                ...
                if(cthis.hasClass('allbody')==false && cthis.hasClass('do-not-set-js-height')==false && cthis.hasClass('dzsparallaxer---window-height')==false && responsive_reference_width==0){
            ...
            function handle_scroll(e, pargs){
                ...
                // console.info('handle_scroll() - ',margs);
                ...
                if(o.mode_scroll=='fromtop'){
                    ...
                    if(o.direction=='reverse'){
                        ...
                        // console.info('analyze vi_y', st, ch, th, $('body').height(), wh, _scrollTop_is_another_element_top);
                ...
                //console.info('direction - ',o.direction,' // o.mode_scroll - ',o.mode_scroll, 'vi_y - ',vi_y);
                ...
                // console.info('mode_scroll - ',o.mode_scroll)
                if(o.mode_scroll=='normal'){
                    ...
                    vi_y = auxer5  * (ch-th);
                    // console.info('analyze vi_y', auxer5, vi_y);
                ...
                var time=0;
                // console.info('handle_scroll()', vi_y, st, ch, th, target_viy);
            ...
            function handle_frame(){
                ...
                // console.info('attempting tu updated .. - ',target_viy)
                if(duration_viy===0){
